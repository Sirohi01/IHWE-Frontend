      ...
      <div className="relative z-10 mx-auto max-w-[1400px] w-full h-full px-6 md:px-12 flex flex-col justify-start pt-0 pb-10">
        ...
        <div className="relative flex items-end justify-between flex-1 mt-0">
          ...
          <div className="flex flex-col items-start pb-4">
            ...
            <h2 className="text-[42px] font-[1000] leading-[0.8] tracking-tighter flex items-center gap-4">
          ...
          <div className="pr-[10px] relative min-w-[260px] h-full">
            <motion.div
              ...
              className="absolute -top-[105px] left-[15px] right-0 bg-[#0B2C66]/95 backdrop-blur-md rounded-[20px] p-[18px_20px] w-[260px] shadow-[0_40px_80px_rgba(0,0,0,0.3)] border border-white/10"
            >
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={i} className="flex gap-3 items-center group">
                    <div className="w-[32px] h-[32px] bg-[#4E9F3D] rounded-full flex-shrink-0 flex items-center justify-center text-white shadow-[0_0_15px_rgba(78,159,61,0.4)] transition-transform group-hover:scale-110">
