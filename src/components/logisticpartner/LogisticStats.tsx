        ...
        {stats.map((stat, index) => (
          <React.Fragment key={index}>
            <motion.div
              ...
              className={`flex items-center gap-[12px] px-2 sm:px-4 group flex-1 justify-start ${index === stats.length - 1 && stats.length % 2 !== 0 ? 'col-span-2 justify-center md:col-span-1 md:justify-start' : 'justify-center md:justify-start'
                }`}
            >
              <div
