        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10 p-8 h-full flex flex-col">
              ...
              <button className="mt-auto w-fit px-8 py-3 bg-white text-[#1A4D2E] rounded-full font-black text-[11px] uppercase tracking-widest flex items-center gap-3 hover:bg-[#0B2C66] hover:text-white transition-all shadow-lg">
                Register For Day 1
          ...
          >
            ...
            <div className="relative z-10 p-8 h-full flex flex-col">
              ...
              <button className="mt-auto w-fit px-8 py-3 bg-white text-[#0B2C66] rounded-full font-black text-[11px] uppercase tracking-widest flex items-center gap-3 hover:bg-[#1E88E5] hover:text-white transition-all shadow-lg">
                Book Delegate Pass
                <ChevronRight className="w-4 h-4" />
              </button>
            </div>
          ...
          >
            ...
            <div className="relative z-10 p-8 h-full flex flex-col">
              ...
              <button className="mt-auto w-fit px-8 py-3 bg-white text-[#1A4D2E] rounded-full font-black text-[11px] uppercase tracking-widest flex items-center gap-3 hover:bg-[#4E9F3D] hover:text-white transition-all shadow-lg">
                Become A Sponsor
                <ChevronRight className="w-4 h-4" />
              </button>
            </div>
