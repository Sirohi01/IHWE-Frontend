          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[14px] font-black text-[#0B2C66] leading-none uppercase">6 POWER-PACKED</span>
                <span className="text-[11px] font-bold text-[#4E9F3D] uppercase tracking-widest mt-1">SESSIONS</span>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <Mic className="w-10 h-10 text-[#4E9F3D] stroke-[2]" />
              <div className="flex flex-col">
                <span className="text-[14px] font-black text-[#0B2C66] leading-none uppercase">WORLD-CLASS</span>
                <span className="text-[11px] font-bold text-[#4E9F3D] uppercase tracking-widest mt-1">SPEAKERS</span>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <Share2 className="w-10 h-10 text-[#4E9F3D] stroke-[2]" />
              <div className="flex flex-col">
                <span className="text-[14px] font-black text-[#0B2C66] leading-none uppercase">UNMATCHED</span>
                <span className="text-[11px] font-bold text-[#4E9F3D] uppercase tracking-widest mt-1">NETWORKING</span>
              </div>
            </div>
          </div>
