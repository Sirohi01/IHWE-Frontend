...
export default function Navbar({ sidebarOpen, setSidebarOpen }) {
    ...
    const initials = currentBuyer?.fullName
        ? currentBuyer.fullName.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2)
        : 'BU';
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center" style={{ height: '48px' }}>
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[12px] font-black text-slate-800 uppercase tracking-widest hidden sm:block font-sans">Buyer Portal</span>
                    </div>
                </div>
            </div>
