...
<section className="px-4 py-4 bg-[#f5f7f6]">
  ...
  <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
    ...
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border flex flex-col">
      ...
      >
        <div>
          <h4 className="text-lg font-bold text-green-800">STARTER <br />VISIBILITY PACKAGE</h4>
          <p className="text-sm text-gray-700 font-semibold">
            Build your presence and get notice online
          </p>
          <p className="text-3xl font-bold text-green-800 mt-2">
          ₹ 12,000 <span className="text-sm text-gray-400">+18% GST</span>
        </p>
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button className="mt-6 w-full border border-green-700 text-green-700 py-2 rounded-lg font-semibold hover:bg-green-700 hover:text-white transition">
          CHOOSE STARTER
        </button>
      </div>
    </div>
    ...
    {/* GROWTH */}
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border-[#e8a415] flex flex-col">
      ...
      {/* HEADER IMAGE */}
      <div
        className="h-40 bg-cover bg-center flex items-end px-5  pt-10"
        style={{ backgroundImage: "url('/images/10.png')" }}
      >
        <div>
          <h4 className="text-lg font-bold text-[#e8a415]">GROWTH <br/> PROMOTION PACKAGE</h4>
          <p className="text-sm text-gray-600 font-semibold">
            Increase engagement and <br/>
            generate more leads
          </p>
           <p className="text-3xl font-bold text-[#d99504] mb-2">
          ₹ 24,000 <span className="text-sm text-gray-400">+18% GST</span>
        </p>
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button className="mt-6 w-full bg-orange-500 text-white py-2 rounded-lg font-semibold hover:bg-orange-600 transition">
          CHOOSE GROWTH
        </button>
      </div>
    </div>
    ...
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border flex flex-col">
      ...
      >
        <div>
          <h4 className="text-lg font-bold text-gray-300">PREMIUM <br/>BRANDING PACKAGE</h4>
          <p className="text-xs text-gray-300 font-semibold">
            Maximize Visibility and<br/> dominate your category

          </p>
           <p className="text-3xl font-bold text-gray-300 mb-2">
          ₹ 45,000 <span className="text-sm text-gray-300">+18% GST</span>
        </p>
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button className="mt-6 w-full bg-green-800 text-white py-2 rounded-lg font-semibold hover:bg-green-700 transition">
          CHOOSE PREMIUM
        </button>
      </div>
    </div>
