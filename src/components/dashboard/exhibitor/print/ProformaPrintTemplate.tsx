...
// Proforma Invoice print — same visual system as the Tax Invoice template,
// mapped onto the Estimate schema's field names (tax/gstRate/disc/finalAmount per item).
