...
import AdminCallFloat from "./AdminCallFloat";

const AdminWhatsAppFloat: React.FC<{ data: any }> = ({ data }) => {
    ...
    return (
        <div className="fixed right-6 bottom-8 z-[60] flex flex-col items-center gap-4 print:hidden">
            {/* Call Button */}
            <AdminCallFloat data={data} />
            ...
            <a
                ...
                onClick={() => analyticsApi.logClick("WhatsApp Icon")}
            >
                {/* Main Button */}
                <div className="relative w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110">
                    {/* WhatsApp Icon */}
                    <svg className="w-[22px] h-[22px] relative z-10" fill="white" viewBox="0 0 24 24">
...
export default AdminWhatsAppFloat;
