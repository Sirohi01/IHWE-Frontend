                        ...
                        <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
                            ...
                            <div className="p-2 flex flex-col gap-1 flex-1 font-inter">
                                ...
                                <div className="grid grid-cols-2 gap-1.5">
                                    <div>
                                        <label className="block text-[11px] font-bold text-black mb-0">Company Name <span className="text-red-500">*</span></label>
                                        <div className="relative">
                                            <Building2 size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-green-700 pointer-events-none" />
                                            <input type="text" placeholder="Enter Company Name" className="w-full pl-6 pr-2 py-1 text-[11px] border border-gray-200 rounded-lg focus:ring-1 focus:ring-green-600/30 focus:border-green-600 outline-none" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-[11px] font-bold text-black mb-0">Contact Person <span className="text-red-500">*</span></label>
                                        <div className="relative">
                                            <User size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-green-700 pointer-events-none" />
                                            <input type="text" placeholder="Enter Contact Person" className="w-full pl-6 pr-2 py-1 text-[11px] border border-gray-200 rounded-lg focus:ring-1 focus:ring-green-600/30 focus:border-green-600 outline-none" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-1.5">
                                    <div>
                                        <label className="block text-[11px] font-bold text-black mb-0">Mobile Number <span className="text-red-500">*</span></label>
                                        <div className="flex border border-gray-200 rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-green-600/30 focus-within:border-green-600">
                                            ...
                                            <input type="tel" placeholder="Mobile Number" className="w-full px-1.5 py-1 text-[11px] outline-none" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-[11px] font-bold text-black mb-0">Email ID</label>
                                        <div className="relative">
                                            <Mail size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-green-700 pointer-events-none" />
                                ...
                                {/* Category */}
                                <div>
                                    <label className="block text-[11px] font-bold text-black mb-0">Product / Service Category</label>
                                    <div className="relative">
                                        <Tag size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-green-700 pointer-events-none" />
                                        <select className="w-full pl-6 pr-5 py-1 text-[11px] border border-gray-200 rounded-lg focus:ring-1 focus:ring-green-600/30 focus:border-green-600 outline-none appearance-none text-gray-500">
                                ...
                                <div>
                                    <div className="flex justify-between items-end mb-0">
                                        <label className="block text-[11px] font-bold text-black">Remarks <span className="text-gray-400 font-normal">(Optional)</span></label>
                                        <span className="text-[8px] text-gray-400">0/300</span>
                                    </div>
                                    <div className="relative">
                                        <PenLine size={12} className="absolute left-2 top-1.5 text-green-700 pointer-events-none" />
                                        <textarea rows={1} placeholder="Write your comments here..." className="w-full pl-6 pr-2 py-1 text-[11px] border border-gray-200 rounded-lg focus:ring-1 focus:ring-green-600/30 focus:border-green-600 outline-none resize-none" />
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#fff9e6] border border-[#f5ebcc] rounded-lg px-2 py-1 flex gap-1.5 items-center">
                                    ...
                                    <p className="text-[8.5px] text-gray-900 font-bold leading-tight">
                                ...
                                <div className="flex justify-start items-center gap-2 mt-auto pt-0.5">
                                    <button onClick={onClose} className="flex items-center gap-1 px-2 py-1 rounded-lg border border-[#041f1a] text-black hover:bg-gray-50 transition-colors shrink-0">
                                        ...
                                        <div className="text-left">
                                            <div className="text-[9px] font-semibold leading-none">Maybe Later</div>
                                            <div className="text-[8px] text-black mt-[1px]">I'll do it later</div>
                                        </div>
                                    </button>
                                    <button className="flex-1 max-w-[160px] bg-gradient-to-r from-[#011e08] to-[#327808] hover:from-[#2a6807] hover:to-[#013e09] text-white py-1 px-2 rounded-lg flex items-center justify-between shadow-lg shadow-green-900/20 transition-all group">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <div className="text-left">
                                                <div className="text-[9.5px] font-medium tracking-wide leading-none">SUBMIT REFERRAL</div>
                                                <div className="text-[7px] text-white mt-[1px]">Let's Refer & Earn Together!</div>
                                            </div>
                                        </div>
