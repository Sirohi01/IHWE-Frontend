...
export default function StatCards() {
    ...
    const stats = [
        ...
        },
        {
            ...
            hoverBg: "hover:to-emerald-100/50",
        ...
        },
        {
            ...
            hoverBg: "hover:to-orange-100/50",
            label: "DOCUMENTS",
        ...
        },
        {
            ...
            cardBg: "bg-gradient-to-br from-white to-teal-50",
            hoverBg: "hover:to-teal-100/50",
