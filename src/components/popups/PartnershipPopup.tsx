...
export default function ExpoSupportPopup() {
        ...
        >
          ...
          >
            ...
            <div className="flex-1 flex flex-col p-8 overflow-hidden">
              ...
              >
                <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center border-2 border-[#2d6a2d] p-1 shadow-sm flex-shrink-0">
                  <img src={pop1} alt="Support" className="w-full h-full object-contain" />
                </div>
                <div>
                  <h2 className="text-[22px] font-bold text-gray-900 leading-tight">Request Expo Support</h2>
                  <p className="text-gray-800 text-[13px]">
                    Share requirements and we'll connect <br />
                    <span className="relative inline-block pb-1">
                      you with the
                      <span className="absolute bottom-[-1px] left-0 w-full h-[2px] bg-[#2d6a2d] rounded-full" />
                    </span>{" "}
                    <span className="text-[#2d6a2d] font-semibold">right partner.</span>
                  </p>
                </div>
              </motion.div>
                    ...
                    {serviceOptions.map(s => {
                      ...
                      return (
                        <button key={s.id} type="button" onClick={() => toggleService(s.id)}
                          className={`relative border-2 rounded-xl pt-2.5 pb-2 px-1.5 flex flex-col items-center gap-1 transition-all cursor-pointer
              ...
              >
                <div className="relative group/btn flex-1">
                  ...
                  <Sparkle style={{ top: '-12px', left: '40%', animationDelay: '0.5s' }} />
                  <Sparkle style={{ top: '-8px', right: '15%', animationDelay: '0.9s' }} />
                  <Sparkle style={{ bottom: '-10px', left: '25%', animationDelay: '0.3s' }} />
                  <Sparkle style={{ bottom: '-12px', right: '30%', animationDelay: '0.7s' }} />
            ...
            {/* ── RIGHT PANEL ── */}
            <div className="w-64 bg-[#f5f9f4] border-l border-gray-100 flex flex-col p-6 relative flex-shrink-0 overflow-hidden">
              <motion.div
              ...
              >
                ...
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md border-2 border-[#2d6a2d] p-0.5 relative">
                ...
                {whyChoose.map((item, i) => (
                  ...
                  >
                    <div className="flex items-start gap-3 py-3">
                      <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center flex-shrink-0 shadow-sm border border-[#e8f5e9]">
                        {item.icon}
                      </div>
                      <div>
                        <p className="text-[12.5px] font-bold text-gray-900 leading-tight">{item.title}</p>
                        <p className="text-[10.5px] text-gray-900 leading-snug">{item.desc}</p>
                      </div>
                    </div>
