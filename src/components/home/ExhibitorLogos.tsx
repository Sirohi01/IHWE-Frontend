...
const ExhibitorLogos = () => {
    ...
    return (
        <section className="py-2 bg-[#050A1A] overflow-hidden">
            <div className="container mx-auto px-4 mb-1">
                ...
                <div className="flex items-center justify-center gap-4 max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center gap-2 px-4 shrink-0">
                        ...
                        <h2 className="text-[#F3B71B] font-bold text-[9px] md:text-[10px] uppercase tracking-[0.25em] whitespace-nowrap">
            ...
            <div className="relative border-y border-white/10 py-1.5">
                <Carousel
                    opts={{ loop: true }}
