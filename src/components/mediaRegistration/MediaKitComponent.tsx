      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-[#003d4d] via-[#001e30] to-[#000a14] flex flex-col lg:flex-row items-center gap-8 overflow-hidden lg:px-8 px-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative flex justify-center items-center w-full lg:w-1/4 h-48 sm:h-64"
          >
            {/* FRONT CARD */}
...
<div className="flex flex-wrap items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex-1 text-center lg:text-left border-l-0 lg:border-l border-white/10 lg:pl-8"
          >
            <motion.h4
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-slate-300 text-sm max-w-md leading-relaxed mx-auto lg:mx-0"
            >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full lg:w-auto lg:pl-8 flex justify-center"
          >
            <motion.button
              whileHover={{
                scale: 1.05,
