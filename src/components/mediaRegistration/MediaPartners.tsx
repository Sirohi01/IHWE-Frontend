...
export default function MediaPartners() {
    return (
        <section className="w-full bg-[#f5f7fb] py-4">
            <SectionContainer className="px-0">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white border border-gray-200 rounded-2xl shadow-sm py-7"
                >
                    {/* HEADING */}
                        ...
                        {partners.map((item, index) => (
                            ...
                            >
                                ...
                                {index !== partners.length - 1 && (
                                    <div className="hidden lg:block absolute top-10 right-[-8px] h-[90px] w-px bg-gray-200" />
                                )}
