                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center py-3.5 bg-white border border-slate-200 text-slate-800 rounded-xl font-bold text-[11px] uppercase tracking-widest active:scale-[0.98] transition-all"
                    >
                      User Login
                    </a>
                  </div>
