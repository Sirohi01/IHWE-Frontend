...
const WhatsAppFloat: React.FC = () => {
    ...
    return (
        <div className="fixed left-6 bottom-20 lg:bottom-8 z-[100] flex flex-col items-center gap-4">
            {/* Call Button */}
            <CallFloat />
            ...
            >
                {/* Main Button */}
                <div className="relative w-10 h-10 lg:w-12 lg:h-12 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110">
                    {/* WhatsApp Icon */}
                    <svg className="w-6 h-6 lg:w-[28px] lg:h-[28px] relative z-10" fill="white" viewBox="0 0 24 24">
