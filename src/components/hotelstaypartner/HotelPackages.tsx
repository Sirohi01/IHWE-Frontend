      ...
      <div className="relative pt-4 pb-3 px-4 text-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-white font-[900] text-xs md:text-[11px] uppercase tracking-[1.2px] leading-tight">
              PARTNERSHIP PACKAGES
            </h3>
            <Star className="w-2.5 h-2.5 fill-[#D4AF37] text-[#D4AF37]" />
            <div className="h-[1px] w-4 bg-gradient-to-r from-[#D4AF37] to-transparent"></div>
          </div>
          <h3 className="text-white font-[900] text-xs md:text-[11px] uppercase tracking-[1.2px] leading-none mt-1 md:mt-0.5">
            &amp; INVESTMENT
          </h3>
        </div>
      </div>
