...
const WhyVisitHero = () => {
    ...
    const stats = [
        { icon: <FaUsers />, num: '8,000+', label: 'Global Visitors' },
        { icon: <FaBuilding />, num: '250+', label: 'Exhibitors' },
        { icon: <FaGlobe />, num: '50+', label: 'Countries' },
        ...
        <div className="w-full overflow-hidden">
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    {/* Top Bar */}
                    <div className="flex items-center gap-5 px-14 py-4 ">
                    ...
                    <div className="flex">
                        ...
                        {/* Left */}
                        <div className="w-full px-8 pt-7 pb-8 flex flex-col gap-4">
                            ...
                            <div className="flex flex-row justify-between w-full items-center">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex items-center gap-2 bg-[#2d6a1f] text-white text-[11px] font-bold uppercase tracking-widest px-5 py-2.5 rounded-full hover:bg-[#245518] transition"
                                    >
                                        Register as Visitor
                                    ...
                                    <button className="flex items-center gap-2 bg-white text-gray-700 text-[11px] font-bold uppercase tracking-widest px-5 py-2.5 rounded-full border border-gray-300 hover:bg-gray-50 transition">
                                        Download Brochure
                                ...
                                {/* Stats */}
                                {/* Stats Bar — right side ke neeche */}
                                <div className="flex items-center justify-between px-6 py-3 bg-[#011630]">
                                    {stats.map((stat, i) => (
                                        <div key={i} className="flex items-center">
                                            <div className="flex items-center gap-2">
                                                <span className="text-[#a8d060]">{stat.icon}</span>
                                                <div>
                                                    <p className="text-white font-black text-sm leading-none">{stat.num}</p>
                                                    <p className="text-gray-400 text-[9px] uppercase tracking-wide leading-tight mt-0.5 whitespace-pre-line">{stat.label}</p>
                                                </div>
                                            </div>
                                            {i < stats.length - 1 && (
                                                <div className="w-px h-8 bg-gray-600 ml-4" />
                                            )}
                                        </div>
                                    ))}
                                </div>
