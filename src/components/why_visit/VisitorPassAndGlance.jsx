...
const stats = [
    { value: "250+", label: "Exhibitors", icon: "/whyVisit/stat_exhibitors.svg", color: "text-[#4a7729]" },
    { value: "8,000+", label: "Visitors", icon: "/whyVisit/stat_visitors.svg", color: "text-[#0f3b73]" },
    { value: "50+", label: "Countries", icon: "/whyVisit/stat_globe.svg", color: "text-[#4a7729]" },
