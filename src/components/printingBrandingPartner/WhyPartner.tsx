...
const WhyPartnerStats = ({ text, icon, showBorder }) => {
    return (
        <div className={`flex justify-center items-center ${showBorder ? 'border-b border-[#294669]' : ''} pb-2`}>
            <div className="img-container bg-[#294669] p-2 rounded-full mr-4">{renderIcon(icon)}</div>
