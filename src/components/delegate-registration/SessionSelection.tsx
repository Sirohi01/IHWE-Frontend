...
const SessionSelection: React.FC = () => {
  ...
  const dayData = [
    ...
    { id: 2, date: "22 AUG 2026", day: "Fri", title: "AYUSH & WELLNESS CONCLAVE" },
    { id: 3, date: "23 AUG 2026", day: "Sat", title: "GLOBAL LEADERSHIP FORUM" },
  ];
  ...
  const sessionsData: Record<number, any[]> = {
    1: [
      ...
      { id: "d1s2", number: "2", time: "12:00 PM – 01:30 PM", title: "Medical Devices & Innovation", description: "Latest trends in medical devices, innovation and modern healthcare.", price: 500 },
    ...
    2: [
      { id: "d2s1", number: "1", time: "10:00 AM – 11:30 AM", title: "Ayush in Modern Healthcare", description: "Integrating traditional Ayush practices with medical systems.", price: 500 },
      { id: "d2s2", number: "2", time: "12:00 PM – 01:30 PM", title: "Wellness & Lifestyle Medicine", description: "The role of preventive care and holistic wellness.", price: 500 },
    ],
    3: [
      { id: "d3s1", number: "1", time: "10:00 AM – 11:30 AM", title: "Healthcare Leadership & Policy", description: "Navigating global health policy and leadership.", price: 500 },
    ],
  };
        ...
        {sessionsData[activeDay]?.map((session) => (
          ...
          >
            ...
            <div className="w-[110px] p-4 flex flex-col items-center justify-center bg-gray-50/20">
              <div className="text-[18px] font-black text-[#143111]">₹{session.price}</div>
        ...
        >
          ...
          <div className="flex-1 p-4 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
              {["All 3 Sessions Access", "Delegate Kit", "Certificate", "Lunch (Thali)"].map((item, idx) => (
          ...
          <div className="w-[110px] p-4 flex flex-col items-center justify-center border-l border-gray-100">
            <div className="text-[18px] font-black text-[#143111]">₹1000</div>
            <div className="text-[9px] font-bold text-gray-400 uppercase tracking-tight mb-3">Per Person</div>
            <div className={`w-7 h-7 rounded border-2 flex items-center justify-center transition-all ${
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="w-[140px] p-4 flex flex-col items-center justify-center border-l border-gray-50 bg-gray-50/10">
              <div className="text-[24px] font-black text-[#0B2C66] leading-none mb-1">₹2500</div>
          ...
          >
            ...
            <div className="w-[140px] p-4 flex flex-col items-center justify-center border-l border-gray-50 bg-gray-50/10">
              <div className="text-[24px] font-black text-[#6A3DF0] leading-none mb-1">₹2500</div>
              <div className="text-[10px] font-bold text-gray-400 uppercase mb-4 tracking-tight">Per Person</div>
              <div className={`w-7 h-7 rounded border-2 flex items-center justify-center transition-all ${
