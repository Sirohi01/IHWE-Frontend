        ...
        {steps.map((step, idx) => (
          <React.Fragment key={step.number}>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center text-[16px] font-black transition-all duration-300 ${currentStep >= step.number
              ...
              <span
                className={`text-[14px] font-bold uppercase tracking-tight ${currentStep >= step.number ? "text-[#143111]" : "text-gray-400"
                  }`}
              >
                {step.title}
              </span>
