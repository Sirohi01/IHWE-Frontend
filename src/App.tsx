...
const AdvisoryBoard = lazy(() => import("./pages/conference_public/AdvisoryBoard"));
const Advisory = lazy(() => import("./pages/conference_public/Advisory"));
const Exhibition = lazy(() => import("./pages/exhibition/Exhibition"));
const ExhibitorProfile = lazy(() => import("./pages/exhibitor/ExhibitorProfile"));
const Partners = lazy(() => import("./pages/partners/Partners"));
import Conference from "./pages/conference_public/Conference";
const Exhibitors = lazy(() => import("./pages/exhibition/Exhibitors"));
const WhyExhibit = lazy(() => import("./pages/info/WhyExhibit"));
const BookAStand = lazy(() => import("./pages/exhibition/BookAStand"));
const Blog = lazy(() => import("./pages/info/Blog"));
const BlogDetail = lazy(() => import("./pages/info/BlogDetail"));
...
const BuyerRegistration = lazy(() => import("./pages/registration/BuyerRegistration"));
const InternationalBuyerRegistration = lazy(() => import("./pages/buyer/InternationalBuyerRegistration"));
const TravelAccommodation = lazy(() => import("./pages/support/TravelAccommodation"));
const MediaRegistration = lazy(() => import("./pages/registration/MediaRegistration"));
const SpeakerRegistration = lazy(() => import("./components/conference/Arogyasangostiform"));
const SellerRegistration = lazy(() => import("./pages/registration/SellerRegistration"));
const StallDesigningVendors = lazy(() => import("./pages/exhibition/StallDesigningVendors"));
const IndustryZoneDetail = lazy(() => import("./pages/exhibition/IndustryZoneDetail"));
const ConferenceDay1 = lazy(() => import("./pages/conference_public/ConferenceDay1"));
const ConferenceDay2 = lazy(() => import("./pages/conference_public/ConferenceDay2"));
const ConferenceDay3 = lazy(() => import("./pages/conference_public/ConferenceDay3"));
...
const ConferenceDayUnified = lazy(() => import("./pages/conference_public/ConferenceDayUnified"));
const TravelPartner = lazy(() => import("./pages/partners/TravelPartner"));
const HotelStayPartner = lazy(() => import("./pages/partners/HotelStayPartner"));
...
const Sponsership = lazy(() => import("./pages/partners/Sponsership"));
const EPromotion = lazy(() => import("./pages/e_promotion_webPage/EPromotion"));
const Partnership = lazy(() => import("./pages/partners/Partnership"));
const Fabricationpartner = lazy(() => import("./pages/partners/Fabricationpartner"));
const PartnerRegistration = lazy(() => import("./pages/registration/PartnerRegistration"));
const LogisticPartner = lazy(() => import("./pages/partners/LogisticPartner"));
const DownloadBadge = lazy(() => import("./pages/scan/DownloadBadge"));
...
const ExhibitorLogin = lazy(() => import("./pages/auth/ExhibitorLogin"));
...
const BuyerLanding = lazy(() => import("./pages/buyer/BuyerLanding"));
const VisitorScan = lazy(() => import("./pages/scan/VisitorScan"));
const BuyerScan = lazy(() => import("./pages/scan/BuyerScan"));
...
const HospitalityPartner = lazy(() => import("./pages/partners/HospitalityPartner"));
