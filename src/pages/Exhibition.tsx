...
const faqs = [
  { q: "When is the exhibition?", a: "March 15-17, 2026 at Dubai World Trade Centre." },
  { q: "What are the booth setup hours?", a: "Setup begins March 13-14, 8am–8pm." },
  ...
  return (
    ...
    <section id="why" className="py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-14" data-aos="fade-up">
          <h2 className="text-3xl font-poppins font-bold text-foreground mb-4">Why Showcase With Us</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={b.title} data-aos="fade-up" className="p-6 rounded-2xl border border-border/50 bg-muted/20 hover:shadow-md transition-shadow">
              ...
              <h3 className="font-poppins font-semibold text-foreground mb-2">{b.title}</h3>
    ...
    <section id="who" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 text-center" data-aos="fade-up">
        <h2 className="text-3xl font-poppins font-bold text-foreground mb-10">Who You'll Meet</h2>
    ...
    <section className="py-20">
      <div className="container mx-auto px-4 text-center" data-aos="fade-up">
        <h2 className="text-3xl font-poppins font-bold text-foreground mb-10">Exhibition Zones</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {["Medical Devices & Equipment", "Pharma & Biotech", "Digital Health & AI", "Hospital Infrastructure", "Diagnostics & Lab", "Wellness & Rehabilitation"].map(z => (
            <div key={z} className="p-6 rounded-2xl gradient-light-blue border border-primary/10 text-center">
              <h3 className="font-poppins font-semibold text-foreground">{z}</h3>
            </div>
          ))}
        </div>
      </div>
    ...
    <section id="reserve" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-poppins font-bold text-foreground text-center mb-12" data-aos="fade-up">Booth Packages</h2>
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {boothPackages.map((pkg, i) => (
            <div key={pkg.name} data-aos="fade-up" data-aos-delay={i * 100} className={`rounded-2xl p-8 border ${pkg.popular ? "border-primary shadow-lg ring-2 ring-primary/20" : "border-border/50"} bg-background relative`}>
              ...
              <h3 className="font-poppins font-bold text-xl text-foreground mb-1">{pkg.name}</h3>
              <div className="text-3xl font-poppins font-bold text-primary mb-1">{pkg.price}</div>
    ...
    <section className="py-20">
      <div className="container mx-auto px-4 max-w-3xl">
        <h2 className="text-3xl font-poppins font-bold text-foreground text-center mb-10" data-aos="fade-up">
