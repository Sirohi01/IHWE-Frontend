          ...
          <div className="premium-card overflow-hidden">
            <div className="bg-primary-green p-6 text-white relative">
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  <p className="text-[10px] uppercase font-black tracking-widest text-emerald-300">Verified Buyer</p>
            ...
            <div className="p-8 space-y-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-black text-slate-800">{currentBuyer.fullName}</h3>
                <p className="text-sm font-bold text-slate-500">{currentBuyer.designation}</p>
                <div className="mt-4 px-4 py-1.5 bg-emerald-50 text-emerald-700 rounded-full text-[10px] font-black uppercase tracking-widest border border-emerald-100">
                  {currentBuyer.registrationCategory}
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-slate-100 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-slate-800">{currentBuyer.registrationId}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Status</span>
                  <span className="text-sm font-bold text-emerald-600 uppercase tracking-widest">{currentBuyer.paymentStatus}</span>
                </div>
              </div>
          ...
          <div className="premium-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-slate-700">{currentBuyer.companyName}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Website</p>
                <p className="text-sm font-bold text-primary-green underline">{currentBuyer.website || 'N/A'}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Business Type</p>
                <p className="text-sm font-bold text-slate-700">{currentBuyer.businessType}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Annual Turnover</p>
                <p className="text-sm font-bold text-slate-700">{currentBuyer.annualTurnover}</p>
              </div>
              <div className="md:col-span-2 space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Registered Office Address</p>
                <p className="text-sm font-bold text-slate-700 leading-relaxed">{currentBuyer.registeredAddress}, {currentBuyer.city}, {currentBuyer.stateProvince}, {currentBuyer.country} - {currentBuyer.pinCode}</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-700">{currentBuyer.mobileNumber}</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-700">{currentBuyer.emailAddress}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="premium-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-slate-700">{currentBuyer.primaryProductInterest}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Buying Frequency</p>
                <p className="text-sm font-bold text-slate-700">{currentBuyer.buyingFrequency}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Purchase Timeline</p>
                <p className="text-sm font-bold text-slate-700">{currentBuyer.purchaseTimeline}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Estimated Annual Purchase</p>
                <p className="text-sm font-bold text-slate-700">{currentBuyer.estimatedAnnualPurchaseValue}</p>
              </div>
            </div>
          </div>
        </div>
