  ...
  <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-3 md:p-4">
    ...
    <div className="flex items-center gap-3">
      <div className="flex flex-1 flex-col md:flex-row md:items-center gap-1 md:gap-3">
        <label className="text-[11.5px] font-semibold text-[#0a2e5c] md:w-44 shrink-0">Select Award Category *</label>
        <select className="flex-1 px-3 py-1.5 border border-slate-200 rounded-md text-[12px] text-slate-400 focus:outline-none focus:ring-1 focus:ring-[#008d48] bg-white appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2020%2020%22%3E%3Cpath%20stroke%3D%22%236b7280%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%221.5%22%20d%3D%22m6%208%204%204%204-4%22%2F%3E%3C%2Fsvg%3E')] bg-[length:1rem_1rem] bg-no-repeat bg-[right_0.5rem_center]">
