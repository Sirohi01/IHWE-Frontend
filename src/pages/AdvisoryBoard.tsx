...
<section className="relative bg-[#f7f7f7] overflow-hidden">
  ...
  <div className="relative max-w-[360px]">
            ...
            {/* BUTTON */}
            <button className="relative z-10 mt-2 bg-[#56b532] hover:bg-[#479d2a] transition-all duration-300 text-white font-black uppercase px-4 py-2 rounded-[12px] flex items-center gap-3 shadow-lg">
    ...
    <div className="relative overflow-hidden rounded-[18px] bg-gradient-to-r from-[#02122b] via-[#041d3d] to-[#02122b] px-6 md:px-10 py-2">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center lg:items-end">
          ...
          <button className="bg-[#56b532] hover:bg-[#469629] transition-all duration-300 text-white font-black uppercase px-3 md:px-4 py-1 rounded-[10px] text-sm md:text-sm flex items-center gap-3 shadow-lg">
