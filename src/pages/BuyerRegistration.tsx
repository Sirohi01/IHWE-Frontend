...
//             if (!pkg) {
//                 alert("Invalid package selected. Please re-select a package.");
//                 return;
//             }
...
//     const inputClasses = "w-full h-8 px-3 py-2 rounded-[2px] border border-slate-400 bg-white text-left text-[12px] font-medium text-slate-900 outline-none shadow-none transition-all ring-offset-background focus:border-[#23471d] focus:ring-[#23471d]/10 placeholder:text-slate-400";
//     const labelClasses = "text-[12px] font-semibold text-slate-900 mb-0.5 block text-left";
...
//                                                             <div key={c} className="flex items-center gap-2 px-2 py-1.5 hover:bg-emerald-50 cursor-pointer text-[12px]">
//                                                                 <Checkbox
...
//                                                         <label key={r} className="flex items-center gap-1 text-[12px] bg-white border border-slate-400 px-2 py-0.5 rounded-[2px] cursor-pointer hover:border-emerald-500">
...
//                                                         <label key={t} className="flex items-center gap-1 text-[12px] bg-white border border-slate-400 px-2 py-0.5 rounded-[2px] cursor-pointer hover:border-emerald-500">
...
//                                                     <label key={c} className="flex items-center gap-1 text-[12px] bg-slate-50 px-2 py-0.5 rounded border border-slate-400 cursor-pointer hover:bg-emerald-50">
...
//                                                 <label className="flex items-center gap-1 text-[12px]"><Checkbox checked={formData.pricingPreference === 'Premium'} onCheckedChange={() => handleSelectChange('pricingPreference', 'Premium')} className="h-3 w-3" /> Premium</label>
//                                                 <label className="flex items-center gap-1 text-[12px]"><Checkbox checked={formData.pricingPreference === 'Mid-Range'} onCheckedChange={() => handleSelectChange('pricingPreference', 'Mid-Range')} className="h-3 w-3" /> Mid-Range</label>
//                                                 <label className="flex items-center gap-1 text-[12px]"><Checkbox checked={formData.pricingPreference === 'Budget'} onCheckedChange={() => handleSelectChange('pricingPreference', 'Budget')} className="h-3 w-3" /> Budget</label>
//                                             </div>
//                                         </div>
//                                     </div>
...
//                                                         className={`relative p-4 border-2 transition-all cursor-pointer rounded-xl flex flex-col h-full ${formData.registrationCategory === pkg.name ? 'border-[#23471d] bg-white shadow-xl ring-4 ring-emerald-50' : 'border-slate-200 bg-white hover:border-emerald-200'}`}
//                                                     >
//                                                         {pkg.isRecommended && (
//                                                             <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-500 text-white text-[10px] font-black px-4 py-1 rounded-full uppercase shadow-lg flex items-center gap-1 z-10">
//                                                                 ⭐ Recommended
//                                                             </div>
//                                                         )}

//                                                         <div className="flex justify-between items-start mb-2">
//                                                             <h4 className="text-[14px] font-black leading-tight flex items-center gap-2 text-slate-800">
//                                                                 {pkg.name === "Standard Buyer Pass" ? "🔹 🟦" : "🔹 🟨"} {pkg.name}
//                                                             </h4>
//                                                             <div className="text-lg font-black text-[#23471d]">₹{pkg.price.toLocaleString()}</div>
//                                                         </div>

//                                                         {pkg.targetAudience && (
//                                                             <div className="text-[11px] font-black text-[#23471d] mb-1 uppercase tracking-tight leading-tight">
//                                                                 {pkg.targetAudience}
//                                                             </div>
//                                                         )}

//                                                         {pkg.description && (
//                                                             <p className="text-[11px] text-slate-600 font-bold mb-3 leading-relaxed border-l-2 border-emerald-500 pl-2">
//                                                                 {pkg.description}
//                                                             </p>
//                                                         )}
...
//                                                                 <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Why Choose This:</p>
//                                                                 <p className="text-[11px] text-[#23471d] font-bold leading-tight">{pkg.whyChoose}</p>
//                                                             </div>
//                                                         )}

//                                                         <div className={`mt-3 w-full py-2 rounded-lg text-center text-[11px] font-black uppercase tracking-wider transition-all ${formData.registrationCategory === pkg.name ? 'bg-[#23471d] text-white' : 'bg-slate-50 text-slate-400 hover:bg-emerald-50 hover:text-emerald-700'}`}>
//                                                             {formData.registrationCategory === pkg.name ? "Selected ✅" : "Select Pass 👉"}
//                                                         </div>
//                                                     </div>
//                                                 ))}
...
//                                                     className="relative p-3 border-2 border-dashed border-emerald-300 bg-emerald-50/20 transition-all cursor-pointer rounded-xl flex flex-col justify-center items-center text-center hover:border-emerald-500 hover:bg-emerald-50/40 h-full min-h-[220px]"
//                                                 >
//                                                     <h4 className="text-[14px] font-black text-emerald-800 mb-1">ICOA Buyer Membership</h4>
//                                                     <div className="text-base font-black text-emerald-600">Upgrade your experience</div>
//                                                     <div className="text-[11px] text-emerald-500 font-bold uppercase mt-3 px-4 py-1.5 border border-emerald-200 rounded-full bg-white shadow-sm hover:bg-emerald-50 transition-colors">View Membership Plans →</div>
//                                                 </div>
//                                             </div>
//                                         ) : (
//                                             <div className="space-y-4">
...
//                                                         <p className="text-[11px] font-black text-slate-600 uppercase tracking-[0.2em]">ICOA Exclusive Membership Plans</p>
//                                                     </div>
//                                                     <Button type="button" onClick={() => setShowMembershipOptions(false)} variant="ghost" className="h-8 text-[11px] text-emerald-700 font-black hover:bg-emerald-50 border border-emerald-100">← Back to Passes</Button>
//                                                 </div>
...
//                                                         >
//                                                             {pkg.badge && (
//                                                                 <div className={`absolute -top-3 left-1/2 -translate-x-1/2 text-white text-[10px] font-black px-4 py-1 rounded-full uppercase shadow-lg flex items-center gap-1 z-10 ${pkg.badge === 'Best Value' ? 'bg-emerald-500' : 'bg-amber-500'}`}>
//                                                                     {pkg.badge === 'Best Value' ? '💎' : '⭐'} {pkg.badge}
//                                                                 </div>
//                                                             )}

//                                                             <div className="flex justify-between items-start mb-2 gap-2">
//                                                                 <h4 className="text-[14px] font-black leading-tight text-slate-800">
//                                                                     {pkg.name.includes('Standard') ? '🔹 🟦' : pkg.name.includes('VIP') ? '🔹 🟨' : pkg.name.includes('Elite') ? '🔹 🟥' : '🔹 🟩'} {pkg.name}
//                                                                 </h4>
//                                                                 <div className="text-lg font-black text-[#23471d] whitespace-nowrap">₹{pkg.price.toLocaleString()}</div>
//                                                             </div>

//                                                             {pkg.targetAudience && (
//                                                                 <div className="text-[11px] font-black text-[#23471d] mb-2 uppercase tracking-tight leading-tight">
//                                                                     {pkg.targetAudience}
//                                                                 </div>
//                                                             )}

//                                                             {pkg.description && (
//                                                                 <p className="text-[11px] text-slate-500 font-bold mb-3 leading-relaxed border-l-2 border-slate-200 pl-2">
//                                                                     {pkg.description}
//                                                                 </p>
//                                                             )}
...
//                                                             <div className={`mt-4 w-full py-2 rounded-lg text-center text-[11px] font-black uppercase tracking-wider transition-all ${formData.registrationCategory === pkg.name ? 'bg-[#23471d] text-white' : 'bg-slate-50 text-slate-400 hover:bg-emerald-50 hover:text-emerald-700'}`}>
//                                                                 {formData.registrationCategory === pkg.name ? "Selected ✅" : (pkg.cta || "Get Started 👉")}
//                                                             </div>
//                                                         </div>
//                                                     ))}
//                                                 </div>
...
//                                                         <strong className="uppercase">Important Note:</strong> Expo entry is free for all visitors. Buyer–Seller Meet is conducted by the International Council of AYUSH (ICOA) at IHWE, ensuring curated B2B interactions and high-quality business engagement.
//                                                     </div>
//                                                 </div>
//                                             </div>
//                                         )}

//                                         <div className="grid grid-cols-1 md:grid-cols-4 gap-3 gap-y-4 gap-x-5 mt-2">
...
//                                             <div><Label className={labelClasses}>Payment Mode *</Label><RadioGroup defaultValue="UPI" onValueChange={(v) => setFormData(p => ({ ...p, paymentMode: v }))} className="flex gap-3"><div className="flex items-center gap-1"><RadioGroupItem value="UPI" id="mode-upi" /><Label htmlFor="mode-upi" className="text-[12px]">UPI</Label></div><div className="flex items-center gap-1"><RadioGroupItem value="Credit/Debit Card" id="mode-card" /><Label htmlFor="mode-card" className="text-[12px]">Card</Label></div><div className="flex items-center gap-1"><RadioGroupItem value="Net Banking" id="mode-net" /><Label htmlFor="mode-net" className="text-[12px]">Net Banking</Label></div></RadioGroup></div>
...
//                                         <div className="grid grid-cols-1 md:grid-cols-2 gap-3 gap-y-4 gap-x-5 items-start">
//                                             <div className="space-y-1">
//                                                 <div className="flex items-start gap-2 p-1"><Checkbox id="consent-terms" checked={formData.consentTerms} onCheckedChange={(c) => setFormData(p => ({ ...p, consentTerms: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-terms" className="text-[11px] leading-tight text-slate-600 font-medium">I agree to Terms & Conditions and Refund Policy *</Label></div>
//                                                 <div className="flex items-start gap-2 p-1"><Checkbox id="consent-valid" checked={formData.consentPaymentValid} onCheckedChange={(c) => setFormData(p => ({ ...p, consentPaymentValid: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-valid" className="text-[11px] leading-tight text-slate-600 font-medium">I confirm that the payment made is valid and non-refundable *</Label></div>
//                                                 <div className="flex items-start gap-2 p-1"><Checkbox id="consent-match" checked={formData.consentMatchedExhibitors} onCheckedChange={(c) => setFormData(p => ({ ...p, consentMatchedExhibitors: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-match" className="text-[11px] leading-tight text-slate-600 font-medium">I agree to be matched with relevant exhibitors *</Label></div>
//                                             </div>
//                                             <div className="flex flex-col items-center">
//                                                 <Button type="submit" disabled={isSubmitting} className="w-inline h-8 bg-[#23471d] hover:bg-[#1a3516] rounded-sm text-white font-bold text-[11px] uppercase tracking-wider shadow-md transition-all flex items-center justify-center gap-2">{isSubmitting ? <Loader2 size={12} className="animate-spin" /> : <>Submit Registration <Send size={11} /></>}</Button>
...
//                                 <div className="p-6 overflow-y-auto text-[12px] leading-relaxed text-slate-600 space-y-4 font-medium custom-scrollbar">
...
//                                             }
//                                         }} />
//                                         <Label htmlFor="modal-consent" className="text-[11px] leading-tight text-slate-700 font-bold">
                                ...
                                <form onSubmit={handleSubmit} className="p-5 space-y-5">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                            ...
                                            <div><Label className={labelClasses}>Designation *</Label><Input required name="designation" value={formData.designation} onChange={handleChange} placeholder="Current Position" className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Company Name *</Label><Input required name="companyName" value={formData.companyName} onChange={handleChange} placeholder="Full Registered Name" className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Business Type *</Label><Select required onValueChange={(v) => handleSelectChange('businessType', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select Type" /></SelectTrigger><SelectContent className={selectContentClasses}>{config?.companyTypes?.map((t: string) => <SelectItem key={t} value={t}>{t}</SelectItem>)}</SelectContent></Select></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                        <div><Label className={labelClasses}>Registered Address *</Label><Input required name="registeredAddress" value={formData.registeredAddress} onChange={handleChange} placeholder="Full Corporate Address" className={inputClasses} /></div>
                                        <div><Label className={labelClasses}>State/Province *</Label><Select onValueChange={(v) => handleSelectChange('stateProvince', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select State" /></SelectTrigger><SelectContent className={`${selectContentClasses} max-h-[200px]`}>{filteredStates.map(s => <SelectItem key={s._id} value={s.name}>{s.name}</SelectItem>)}</SelectContent></Select></div>
                                        <div><Label className={labelClasses}>City *</Label><Select onValueChange={(v) => handleSelectChange('city', v)} disabled={!formData.stateProvince}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select City" /></SelectTrigger><SelectContent className={`${selectContentClasses} max-h-[200px]`}>{filteredCities.map(c => <SelectItem key={c._id} value={c.name}>{c.name}</SelectItem>)}</SelectContent></Select></div>
                                        <div><Label className={labelClasses}>Pin Code *</Label><Input required name="pinCode" value={formData.pinCode} onChange={handleChange} placeholder="Postal Code" className={inputClasses} /></div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 gap-y-4 gap-x-5">
                                            <div><Label className={labelClasses}>Years in Operation *</Label><Input type="date" required name="yearsInOperation" value={formData.yearsInOperation} onChange={handleChange} className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Annual Turnover *</Label><Select onValueChange={(v) => handleSelectChange('annualTurnover', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Choose Range" /></SelectTrigger><SelectContent className={selectContentClasses}>{config?.annualTurnoverRanges?.map((r: string) => <SelectItem key={r} value={r}>{r}</SelectItem>)}</SelectContent></Select></div>
                                            <div><Label className={labelClasses}>Key Products / Services *</Label><Input required name="keyProductsServices" value={formData.keyProductsServices} onChange={handleChange} placeholder="Your primary offerings..." className={inputClasses} /></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                            ...
                                            <div><Label className={labelClasses}>Estimated Purchase Volume</Label><Input name="estimatedPurchaseVolume" value={formData.estimatedPurchaseVolume} onChange={handleChange} placeholder="e.g. 5000 Units" className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Budget Range</Label><Select onValueChange={(v) => handleSelectChange('budgetRange', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Choose Budget" /></SelectTrigger><SelectContent className={selectContentClasses}>{config?.budgetRanges?.map((b: string) => <SelectItem key={b} value={b}>{b}</SelectItem>)}</SelectContent></Select></div>
                                        </div>
                                        <div className="mt-1">
                                            <Label className={labelClasses}>Specific Product Requirements</Label>
                                            <Textarea name="specificProductRequirements" value={formData.specificProductRequirements} onChange={handleChange} className={`${inputClasses} h-auto min-h-[50px] py-1`} placeholder="Any custom needs..." />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                            <div className="space-y-1">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['North India', 'South India', 'East India', 'West India', 'Pan India'].map((r: string) => (
                                                        <label key={r} className={`flex items-center gap-1 ${checkboxLabelClasses} bg-white border border-slate-400 px-2 py-0.5 rounded-[2px] cursor-pointer hover:border-emerald-500`}>
                                                            <Checkbox checked={formData.preferredSupplierRegion.includes(r)} onCheckedChange={(checked) => handleCheckboxChange('preferredSupplierRegion', r, !!checked)} className="h-3 w-3" /> {r}
                                                        </label>
                                                    ))}
                                                </div>
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {['Manufacturer', 'Exporter', 'MSME', 'Startup', 'Wholesaler'].map((t: string) => (
                                                        <label key={t} className={`flex items-center gap-1 ${checkboxLabelClasses} bg-white border border-slate-400 px-2 py-0.5 rounded-[2px] cursor-pointer hover:border-emerald-500`}>
                                                            <Checkbox checked={formData.preferredSupplierType.includes(t)} onCheckedChange={(checked) => handleCheckboxChange('preferredSupplierType', t, !!checked)} className="h-3 w-3" /> {t}
                                                        </label>
                                                    ))}
                                                </div>
                                    ...
                                    <div className="space-y-2 ">
                                        <h3 className={sectionTitleClasses}> Purchase Intent & Capacity</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                            <div><Label className={labelClasses}>Buying Frequency *</Label><Select value={formData.buyingFrequency} onValueChange={(v) => handleSelectChange('buyingFrequency', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select" /></SelectTrigger><SelectContent className={selectContentClasses}>{['One-time', 'Monthly', 'Quarterly', 'Long-term'].map(f => <SelectItem key={f} value={f}>{f}</SelectItem>)}</SelectContent></Select></div>
                                            <div><Label className={labelClasses}>Est. Annual Purchase Value *</Label><Select value={formData.estimatedAnnualPurchaseValue} onValueChange={(v) => handleSelectChange('estimatedAnnualPurchaseValue', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Choose Range" /></SelectTrigger><SelectContent className={selectContentClasses}>{config?.annualPurchaseValueRanges?.map((v: string) => <SelectItem key={v} value={v}>{v}</SelectItem>)}</SelectContent></Select></div>
                                            <div><Label className={labelClasses}>Purchase Timeline *</Label><Select value={formData.purchaseTimeline} onValueChange={(v) => handleSelectChange('purchaseTimeline', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select" /></SelectTrigger><SelectContent className={selectContentClasses}>{['Immediate', '1–3 Months', '3–6 Months', 'Exploring'].map(t => <SelectItem key={t} value={t}>{t}</SelectItem>)}</SelectContent></Select></div>
                                            <div><Label className={labelClasses}>Role in Purchase Decision *</Label><Select value={formData.roleInPurchaseDecision} onValueChange={(v) => handleSelectChange('roleInPurchaseDecision', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select Role" /></SelectTrigger><SelectContent className={selectContentClasses}>{['Final Decision Maker', 'Influencer', 'Research Only'].map(r => <SelectItem key={r} value={r}>{r}</SelectItem>)}</SelectContent></Select></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 gap-y-4 gap-x-5">
                                            <div><Label className={labelClasses}>Preferred Meeting Date *</Label><Input type="date" required name="preferredMeetingDate" value={formData.preferredMeetingDate} onChange={handleChange} className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Preferred Time Slot *</Label><Select onValueChange={(v) => handleSelectChange('preferredTimeSlot', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Select Slot" /></SelectTrigger><SelectContent className={selectContentClasses}><SelectItem value="Morning (10AM - 1PM)">Morning (10AM - 1PM)</SelectItem><SelectItem value="Afternoon (2PM - 4PM)">Afternoon (2PM - 4PM)</SelectItem><SelectItem value="Evening (4PM - 6PM)">Evening (4PM - 6PM)</SelectItem></SelectContent></Select></div>
                                            <div><Label className={labelClasses}>Pre-scheduled sB2B *</Label><Select defaultValue="Yes" onValueChange={(v) => handleSelectChange('requirePreScheduledB2B', v)}><SelectTrigger className={inputClasses}><SelectValue placeholder="Yes/No" /></SelectTrigger><SelectContent className={selectContentClasses}><SelectItem value="Yes">Yes</SelectItem><SelectItem value="No">No</SelectItem></SelectContent></Select></div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {!showMembershipOptions ? (
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch">
                                                {passPackages.map((pkg: any) => (
                                                    ...
                                                    >
                                                        {pkg.isRecommended && (
                                                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-500 text-white text-[10px] font-black px-4 py-1 rounded-full uppercase shadow-lg flex items-center gap-1 z-10 font-sans">
                                                                ⭐ Recommended
                                                            </div>
                                                        )}

                                                        <div className="flex justify-between items-start mb-2">
                                                            <h4 className="text-[14px] font-black leading-tight flex items-center gap-2 text-slate-800 font-sans">
                                                                {pkg.name === "Standard Buyer Pass" ? "🔹 🟦" : "🔹 🟨"} {pkg.name}
                                                            </h4>
                                                            <div className="text-lg font-black text-[#23471d] font-sans">₹{pkg.price.toLocaleString()}</div>
                                                        </div>

                                                        {pkg.targetAudience && (
                                                            <div className="text-[11px] font-black text-[#23471d] mb-1 uppercase tracking-tight leading-tight font-sans">
                                                                {pkg.targetAudience}
                                                            </div>
                                                        )}

                                                        {pkg.description && (
                                                            <p className="text-[11px] text-slate-600 font-bold mb-3 leading-relaxed border-l-2 border-emerald-500 pl-2 font-sans">
                                                                {pkg.description}
                                                            </p>
                                                        )}

                                                        <div className="flex-1 space-y-2">
                                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-sans">What You Get:</p>
                                                        ...
                                                        {pkg.whyChoose && (
                                                            <div className="mt-4 pt-3 border-t border-slate-100">
                                                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1 font-sans">Why Choose This:</p>
                                                                <p className="text-[11px] text-[#23471d] font-bold leading-tight font-sans">{pkg.whyChoose}</p>
                                                            </div>
                                                        )}
                                                ...
                                                <div
                                                    onClick={() => setShowMembershipOptions(true)}
                                                    className="relative p-3 border-2 border-dashed border-emerald-300 bg-emerald-50/20 transition-all cursor-pointer rounded-xl flex flex-col justify-center items-center text-center hover:border-emerald-500 hover:bg-emerald-50/40 h-full min-h-[220px] font-sans"
                                                >
                                                    <h4 className="text-[14px] font-black text-emerald-800 mb-1 font-sans">ICOA Buyer Membership</h4>
                                                    <div className="text-base font-black text-emerald-600 font-sans">Upgrade your experience</div>
                                                    <div className={`text-[11px] text-emerald-500 font-bold uppercase mt-3 px-4 py-1.5 border border-emerald-200 rounded-full bg-white shadow-sm hover:bg-emerald-50 transition-colors font-sans`}>View Membership Plans →</div>
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between px-2">
                                                    <div className="flex items-center gap-2">
                                                        <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
                                                        <p className="text-[11px] font-black text-slate-600 uppercase tracking-[0.2em] font-sans">ICOA Exclusive Membership Plans</p>
                                                    </div>
                                                    <Button type="button" onClick={() => setShowMembershipOptions(false)} variant="ghost" className={`h-8 text-[11px] text-emerald-700 font-black hover:bg-emerald-50 border border-emerald-100 ${buttonTextClasses}`}>← Back to Passes</Button>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch">
                                                    {membershipPackages.map((pkg: any) => (
                                                        ...
                                                        >
                                                            {pkg.badge && (
                                                                <div className={`absolute -top-3 left-1/2 -translate-x-1/2 text-white text-[10px] font-black px-4 py-1 rounded-full uppercase shadow-lg flex items-center gap-1 z-10 font-sans ${pkg.badge === 'Best Value' ? 'bg-emerald-500' : 'bg-amber-500'}`}>
                                                                    {pkg.badge === 'Best Value' ? '💎' : '⭐'} {pkg.badge}
                                                                </div>
                                                            )}
                                                            ...
                                                            <div className="flex justify-between items-start mb-2 gap-2">
                                                                ...
                                                                <div className="text-lg font-black text-[#23471d] whitespace-nowrap font-sans">₹{pkg.price.toLocaleString()}</div>
                                                            </div>

                                                            {pkg.targetAudience && (
                                                                <div className="text-[11px] font-black text-[#23471d] mb-2 uppercase tracking-tight leading-tight font-sans">
                                                                    {pkg.targetAudience}
                                                                </div>
                                                            )}

                                                            {pkg.description && (
                                                                <p className="text-[11px] text-slate-500 font-bold mb-3 leading-relaxed border-l-2 border-slate-200 pl-2 font-sans">
                                                                    {pkg.description}
                                                                </p>
                                                            )}
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 gap-y-4 gap-x-5 mt-2">
                                            <div><Label className={labelClasses}>Registration Fee</Label><Input value={formData.registrationFee} disabled className={`${inputClasses} bg-slate-50`} placeholder="Fee" /></div>
                                            <div><Label className={labelClasses}>Payment Mode *</Label><RadioGroup defaultValue="UPI" onValueChange={(v) => setFormData(p => ({ ...p, paymentMode: v }))} className="flex gap-3"><div className="flex items-center gap-1"><RadioGroupItem value="UPI" id="mode-upi" /><Label htmlFor="mode-upi" className={checkboxLabelClasses}>UPI</Label></div><div className="flex items-center gap-1"><RadioGroupItem value="Credit/Debit Card" id="mode-card" /><Label htmlFor="mode-card" className={checkboxLabelClasses}>Card</Label></div><div className="flex items-center gap-1"><RadioGroupItem value="Net Banking" id="mode-net" /><Label htmlFor="mode-net" className={checkboxLabelClasses}>Net Banking</Label></div></RadioGroup></div>
                                            <div><Label className={labelClasses}>Transaction ID / Reference *</Label><Input required name="transactionId" value={formData.transactionId} onChange={handleChange} placeholder="UTR / Ref Number" className={inputClasses} /></div>
                                            <div><Label className={labelClasses}>Upload Payment Proof *</Label><Input type="file" required accept="image/*" onChange={handleFileChange} className={`${inputClasses} pt-1`} placeholder="No file chosen" /></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-2 space-y-3 border-t border-slate-200">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 gap-y-4 gap-x-5 items-start">
                                            <div className="space-y-1">
                                                <div className="flex items-start gap-2 p-1"><Checkbox id="consent-terms" checked={formData.consentTerms} onCheckedChange={(c) => setFormData(p => ({ ...p, consentTerms: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-terms" className="text-[11px] leading-tight text-slate-600 font-medium font-sans">I agree to Terms & Conditions and Refund Policy *</Label></div>
                                                <div className="flex items-start gap-2 p-1"><Checkbox id="consent-valid" checked={formData.consentPaymentValid} onCheckedChange={(c) => setFormData(p => ({ ...p, consentPaymentValid: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-valid" className="text-[11px] leading-tight text-slate-600 font-medium font-sans">I confirm that the payment made is valid and non-refundable *</Label></div>
                                                <div className="flex items-start gap-2 p-1"><Checkbox id="consent-match" checked={formData.consentMatchedExhibitors} onCheckedChange={(c) => setFormData(p => ({ ...p, consentMatchedExhibitors: !!c }))} className="h-3 w-3 mt-0.5" /><Label htmlFor="consent-match" className="text-[11px] leading-tight text-slate-600 font-medium font-sans">I agree to be matched with relevant exhibitors *</Label></div>
                                            </div>
                                            <div className="flex flex-col items-center">
