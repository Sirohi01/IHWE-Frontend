      ...
      < div className="bg-white py-2 px-4 lg:px-16 z-30" >
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row justify-end items-center gap-4">
            ...
            <Button variant="outline" className="h-12 px-8 bg-white border-slate-200 text-[#064420] font-black text-[12px] uppercase tracking-[0.1em] rounded hover:bg-[#064420] transition-all flex items-center gap-4 group">
            ...
            {[
              ...
              <div key={i} className={`flex items-center gap-4 px-6 ${i !== 5 ? "lg:border-r border-slate-100" : ""} group`}>
                <div className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center shrink-0 group-hover:bg-[#23471d]/5 transition-colors">
                  <stat.icon size={24} className="text-[#23471d]" />
                </div>
                <div>
                  <div className="text-xl font-black text-slate-900 leading-none mb-1">{stat.val}</div>
                  <div className="text-[9px] font-bold text-slate-400 tracking-widest uppercase leading-tight">{stat.label}</div>
                </div>
              </div>
            ))}
          </div>
                ...
                {[
                  ...
                  <div key={i} className={`p-5 hover:bg-slate-50 transition-all border-b border-r border-slate-100 last:border-r-0 group`}>
                    <div className="flex flex-row gap-4 items-start">
                      <div className="w-10 h-10 bg-[#1a3615] rounded-full flex items-center justify-center text-white shrink-0 shadow-lg group-hover:scale-110 transition-transform">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-7 gap-5">
                      ...
                      <div className="md:col-span-4 space-y-1 flex flex-col">
                        ...
                        <div className="flex-1 border border-dashed border-slate-200 rounded-md flex flex-col items-center justify-center bg-[#f9fafb] hover:bg-slate-50 transition-colors cursor-pointer group p-3">
                          <Upload size={20} className="text-slate-400 mb-1 group-hover:text-[#1a3615] transition-colors" />
                          <p className="text-[10px] font-black text-slate-700">Drag & drop files here</p>
                          <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">or <span className="text-[#1a3615] underline">Browse Files</span></p>
                        </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4 relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
                <div className="w-24 h-24 shrink-0 flex items-center justify-center relative">
                  ...
                  <span className="text-6xl drop-shadow-xl transform -rotate-12">📢</span>
                </div>

                <div className="space-y-2">
                  <h3 className="text-2xl md:text-2xl font-black text-white leading-tight tracking-tight">
                    Don't Miss This <span className="text-[#f3b71b]">Government-Supported</span> Opportunity!
                  </h3>
                  <p className="text-white/70 text-sm md:text-[16px] font-bold max-w-2xl leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-5 shrink-0 w-full lg:w-auto">
                <Button className="h-14 px-10 bg-orange-500 hover:bg-orange-600 text-white font-black text-[13px] uppercase tracking-[0.15em] rounded-md shadow-xl transition-all flex items-center justify-center gap-4 group/btn">
                  APPLY NOW <ArrowRight size={18} className="group-hover/btn:translate-x-1 transition-transform" />
                </Button>
                <Button variant="outline" className="h-14 px-10 border-white/20 bg-[#1a3615] text-white hover:bg-white/10 font-black text-[13px] uppercase tracking-[0.15em] rounded-md transition-all flex items-center justify-center gap-4 group/btn">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 lg:gap-12 w-full lg:w-auto">
              {[
                ...
                { icon: Users, val: "20,000+", label: "TRADE VISITORS" },
                { icon: Mic, val: "50+", label: "CONFERENCE SESSIONS" },
                { icon: Briefcase, val: "3 DAYS", label: "OF BUSINESS OPPORTUNITIES" },
              ].map((stat, i) => (
            ...
            <div className="flex flex-col items-center lg:items-end gap-4 shrink-0">
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Linkedin, Youtube].map((Icon, i) => (
                  <a key={i} href="#" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:bg-[#23471d] hover:text-white transition-all hover:border-transparent">
                    <Icon size={18} />
                  </a>
                ))}
              </div>
