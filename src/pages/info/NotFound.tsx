    ...
    <div className="flex min-h-[100vh] flex-col items-center justify-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
          ...
          <Link to="/">
            {settings?.logo ? (
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs font-bold text-[#d26019] tracking-[0.2em] uppercase">EXPO 2026</span>
              </div>
            )}
          </Link>
        </div>
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            to="/"
            className="rounded-full bg-[#23471d] px-8 py-3.5 text-sm font-bold text-white shadow-sm hover:bg-[#1a3516] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#23471d] transition-all duration-300 flex items-center gap-2"
          >
