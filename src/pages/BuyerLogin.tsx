                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            { icon: IdCardIcon, title: "Buyer Badge", desc: "Download your badge" },
                                    ...
                                    {step === 1 ? (
                                        ...
                                        >
                                            <div className="text-center lg:text-left">
                                                <h3 className="text-3xl font-inter font-bold text-slate-900 mb-2">Buyer Login</h3>
                                                <p className="text-slate-500 text-sm">Please sign in to your buyer account</p>
                                            </div>
