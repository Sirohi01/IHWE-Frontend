...
import { ArrowLeft, Clock, Bell, Rocket, Sparkles } from "lucide-react";
...
const InternationalBuyerRegistration = () => {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center relative overflow-hidden font-sans">
            ...
            >
                <div className="absolute inset-0 bg-gradient-to-br from-[#23471d]/95 via-[#1a3515]/90 to-black/80" />
            </div>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute bottom-20 right-10 text-emerald-300 opacity-20"
                >
                    <Rocket size={160} />
                </motion.div>
            </div>
            ...
            <motion.div
                ...
                className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center max-w-3xl"
            >
                {/* Badge */}
                <motion.div
                    initial={{ scale: 0 }}
                    ...
                    className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-[11px] font-black uppercase tracking-[0.3em] mb-8"
                >
                ...
                {/* Main Heading */}
                <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6 tracking-tight leading-[1.1]">
                ...
                {/* Description */}
                <p className="text-lg md:text-xl text-emerald-50/70 mb-10 leading-relaxed font-light">
                    We're putting the finishing touches on our global buyer portal.
                    Get ready to connect with the finest weavers and artisans at the
                    <span className="text-white font-semibold"> 9th IHWE 2026</span>.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
                    <Link to="/" className="w-full sm:w-auto">
                        <Button
                            className="w-full sm:w-auto group relative h-14 px-8 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase tracking-[0.2em] shadow-xl shadow-emerald-900/20 transition-all hover:scale-105 active:scale-95 overflow-hidden"
                        >
                            ...
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-r from-emerald-400/0 via-white/10 to-emerald-400/0"
                                animate={{ x: ['-100%', '200%'] }}
                    ...
                    <Button
                        variant="outline"
                        className="w-full sm:w-auto h-14 px-8 rounded-full border-white/20 bg-white/5 hover:bg-white/10 text-white font-black uppercase tracking-[0.2em] backdrop-blur-sm transition-all hover:border-white/40"
                    >
                ...
                <div className="mt-16 w-full max-w-sm">
                    <div className="flex justify-between text-[10px] font-black uppercase tracking-widest text-emerald-400/60 mb-2">
                    ...
                    <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden">
                        <motion.div
                            ...
                            className="h-full bg-gradient-to-r from-emerald-500 to-emerald-300 shadow-[0_0_15px_rgba(16,185,129,0.5)]"
                        />
                    </div>
                </div>
            </motion.div>
            ...
            <div className="absolute bottom-10 left-0 right-0 text-center z-10">
                <p className="text-[10px] text-emerald-500/40 uppercase tracking-[0.5em] font-black">
                    Powered by ICOA • 9th IHWE 2026
                </p>
            </div>
        </div>
    );
...
// export default InternationalBuyerRegistration;s